  ...
  const ws = await import("ws");
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const base_url = "https://x2twitter.com", base_headers = {
                accept: "*/*",
            ...
            const t = await axios
                ...
                if (v.token)
                    ...
                    console.error(new Error(`Failed to get JWT no token in response : ${v}`));
                return "";
            })
                .catch((e) => {
                                ...
                                ? await (async () => {
                                    return new Promise(async (res, rej) => {
                                        try {
                                            ...
                                            if (!url)
                                                throw new Error(`Failed getting convert url`);
                                            const a = await axios
